...
beam_sound = pygame.mixer.Sound('assets/sounds/beam.mp3')
...
row1_top = r1 - 5 * sect
#background image
wallpaper = pygame.transform.scale(pygame.image.load('assets/images/wallpaper/wall1.jpg'), (window_w, window_h))
#godzilla
zilla1 = pygame.transform.scale(pygame.image.load('assets/images/godzilla/godzilla1.png'), (section_w * 5, section_h * 5))
zilla2 = pygame.transform.scale(pygame.image.load('assets/images/godzilla/godzilla2.png'), (section_w * 5, section_h * 5))
zilla3 = pygame.transform.scale(pygame.image.load('assets/images/godzilla/godzilla3.png'), (section_w * 5, section_h * 5))
#godzilla attack
beam_img = pygame.transform.scale(pygame.image.load('assets/images/godzilla/beam.png'), (section_w * 2, section_h * 1.5))
#baby kong
...
#GUI
def draw_extras():
    screen.blit(font.render(f'I•{state.score}', True, 'grey'), (3*section_w, 2*section_h))
    screen.blit(font.render(f'TOP•{state.high_score}', True, 'grey'), (14 * section_w, 2 * section_h))
    screen.blit(font.render(f'[  ][        ]', True, 'grey'), (20 * section_w, 4 * section_h))
    screen.blit(font2.render(f'  M    BONUS ', True, 'grey'), (20 * section_w + 5, 4 * section_h))
    screen.blit(font2.render(f'  {state.lives}       {state.bonus}  ', True, 'grey'),

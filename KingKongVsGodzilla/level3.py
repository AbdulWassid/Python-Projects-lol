...
pygame.display.set_caption('King Kong vs. Space Godzilla!')
...
volume = 0.7
#Sounds
theme = pygame.mixer.Sound('assets/sounds/theme3.mp3')
theme.set_volume(theme_vol)
beam_sound = pygame.mixer.Sound('assets/sounds/beam3.mp3')
...
row1_top = r1 - 5 * sect
#background image
wallpaper = pygame.transform.scale(pygame.image.load('assets/images/wallpaper/wall3.png'), (window_w, window_h))
#space godzilla
zilla1 = pygame.transform.scale(pygame.image.load('assets/images/space/space_godzilla1.png'), (section_w * 5, section_h * 5))
zilla2 = pygame.transform.scale(pygame.image.load('assets/images/space/space_godzilla2.png'), (section_w * 5, section_h * 5))
zilla3 = pygame.transform.scale(pygame.image.load('assets/images/space/space_godzilla3.png'), (section_w * 5, section_h * 5))
#godzilla attack
beam_img = pygame.transform.scale(pygame.image.load('assets/images/space/beam3.png'), (section_w * 2, section_h * 1.5))
#baby kong
...
#GUI
def draw_extras():
    screen.blit(font.render(f'I•{state.score}', True, 'cyan'), (3*section_w, 2*section_h))
    screen.blit(font.render(f'TOP•{state.high_score}', True, 'cyan'), (14 * section_w, 2 * section_h))
    screen.blit(font.render(f'[  ][        ]', True, 'cyan'), (20 * section_w, 4 * section_h))
    screen.blit(font2.render(f'  M    BONUS ', True, 'cyan'), (20 * section_w + 5, 4 * section_h))
    screen.blit(font2.render(f'  {state.lives}       {state.bonus}  ', True, 'cyan'),

...
pygame.display.set_caption('King Kong vs. Ghidorah!')
...
volume = 0.7
#Sounds
theme = pygame.mixer.Sound('assets/sounds/theme4.mp3')
theme.set_volume(theme_vol)
beam_sound = pygame.mixer.Sound('assets/sounds/beam4.mp3')
beam_sound.set_volume(beam_vol)
...
row1_top = r1 - 5 * sect
#background image
wallpaper = pygame.transform.scale(pygame.image.load('assets/images/wallpaper/wall4.png'), (window_w, window_h))
#space godzilla
zilla1 = pygame.transform.scale(pygame.image.load('assets/images/ghidorah/ghidorah1.png'), (section_w * 5, section_h * 5))
zilla2 = pygame.transform.scale(pygame.image.load('assets/images/ghidorah/ghidorah2.png'), (section_w * 5, section_h * 5))
zilla3 = pygame.transform.scale(pygame.image.load('assets/images/ghidorah/ghidorah3.png'), (section_w * 5, section_h * 5))
#godzilla attack
beam_img = pygame.transform.scale(pygame.image.load('assets/images/ghidorah/beam.png'), (section_w * 2, section_h * 1.5))
#baby kong
...
#GUI
def draw_extras():
    screen.blit(font.render(f'I•{state.score}', True, 'green'), (3*section_w, 2*section_h))
    screen.blit(font.render(f'TOP•{state.high_score}', True, 'green'), (14 * section_w, 2 * section_h))
    screen.blit(font.render(f'[  ][        ]', True, 'green'), (20 * section_w, 4 * section_h))
    screen.blit(font2.render(f'  M    BONUS ', True, 'green'), (20 * section_w + 5, 4 * section_h))
    screen.blit(font2.render(f'  {state.lives}       {state.bonus}  ', True, 'green'),
...
def show_victory_screen():
    ...
    screen.blit(font.render('CONGRATULATIONS!', True, 'gold'), (window_w//2 - 200, window_h//2 - 100))
    screen.blit(font.render('YOU DEFEATED GHIDORAH!', True, 'gold'), (window_w//2 - 250, window_h//2 - 50))
    screen.blit(font2.render(f'Final Score: {state.score}', True, 'white'), (window_w//2 - 100, window_h//2))
    screen.blit(font2.render('Press R to Restart', True, 'white'), (window_w//2 - 100, window_h//2 + 50))
    screen.blit(font2.render('Press Q to Quit', True, 'white'), (window_w//2 - 100, window_h//2 + 100))
    pygame.display.flip()
...
def reset_game_completely():
    ...
    #reset game
    state.reset()
    state.active_level = 0  #will try to go back to first level
    ...
    #re init the clubs for level 0
    if levels and 'Clubs' in levels[state.active_level]:
        for stick in levels[state.active_level]['Clubs']:
            Clubs.add(Club(*stick))
